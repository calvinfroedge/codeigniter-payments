...
{	
	...
	*/	
	...
	private function _handle_query()
	{
		...
		include 'beanstream/request.php';
		include 'beanstream/response.php';
		
		$make_request = Beanstream_Request::make_request($this->_http_query);
		$gateway_response = Beanstream_Response::parse_response($make_request);
